...
def main(stdscr):
    ...
    curses.init_pair(5, curses.COLOR_WHITE, curses.COLOR_BLACK) # Для рамки
    
    def reset_game():
        nonlocal board, revealed, flags, cx, cy, game_over, won
        board = create_board()
    ...
    while True:
        ...
        if game_over:
            ...
            stdscr.addstr(start_y + HEIGHT + 2, (term_width - len(msg)) // 2, msg, curses.color_pair(3) | curses.A_BOLD)
        elif won:
            msg = "Good work! [R] Restart | [Q] Quit"
            stdscr.addstr(start_y + HEIGHT + 2, (term_width - len(msg)) // 2, msg, curses.color_pair(2) | curses.A_BOLD)
